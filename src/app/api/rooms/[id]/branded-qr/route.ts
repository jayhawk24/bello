        ...
        <body>
            ...
            <main class="qr-card">
                <header class="card-header">
                    ...
                    <div>
                        <p class="hotel-label">Bello Hospitality</p>
                    ...
                    <ol class="instruction-list">
                        ...
                        <li>
                            ...
                            <div class="step-body">
                                ...
                                <p>Hold steady until the prompt appears confirming Bello room services.</p>
                            </div>
                        </li>
                        <li>
                            <div class="step-icon"></div>
                            <div class="step-body">
                                <p class="step-title">Tap the Bello link to continue</p>
