    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100 flex items-center justify-center p-6">
            <div className="card-minion max-w-md w-full text-center">
                <div className="mb-6">
                    <div className="w-20 h-20 bg-minion-yellow rounded-full flex items-center justify-center mb-6 mx-auto">
                        <span className="text-4xl">📱</span>
                    </div>
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">Room Access</h1>
                    <p className="text-gray-600">
                        Scan your room QR code or enter your access code to view available services
                    </p>
                </div>
                ...
                <div className="mb-8">
                    {!showScanner ? (
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 bg-gray-50">
                            ...
                            <p className="text-gray-600 mb-6">Ready to scan your room QR code?</p>
                            <button
                        ...
                        <div className="border-2 border-minion-yellow rounded-lg overflow-hidden bg-black">
                            <div className="bg-minion-yellow text-gray-800 py-2 px-4 text-center font-medium">
                                QR Code Scanner - Point camera at QR code
                            </div>
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    disabled={isStopping}
                                    className={`absolute top-2 right-2 px-3 py-1 rounded text-sm z-20 ${isStopping
                ...
                <div className="mb-8">
                    <div className="bg-gray-50 p-6 rounded-lg border">
                        <p className="text-sm text-gray-600 mb-4">
                            <strong>Alternative:</strong> Enter your room access code manually
                        </p>
                        ...
                        <form onSubmit={handleRoomCodeSubmit} className="space-y-4">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder="Enter room code or paste QR URL"
                                    className="input-minion text-center"
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">
                                    Format: HOTEL-ROOM-ACCESS or full QR code URL
                                </p>
                            </div>
