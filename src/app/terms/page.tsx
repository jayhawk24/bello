        ...
        <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100">
            ...
            <main className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="card-minion p-8 prose prose-lg max-w-none">
                    ...
                    <p>
                        By accessing and using StayScan's concierge services, you accept and agree to be bound by
                        the terms and provision of this agreement.
                    </p>

                    <h2>Use License</h2>
                    <p>
                        Permission is granted to temporarily use StayScan's services for personal, non-commercial
                    ...
                    <p>
                        StayScan shall not be liable for any damages arising from the use or inability to use
                        our services, including but not limited to direct, indirect, incidental, or consequential damages.
                    </p>

                    <h2>Modifications</h2>
                    <p>
                        StayScan may revise these terms at any time without notice. By using this service,
