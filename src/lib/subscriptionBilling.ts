...
export class SubscriptionBillingService {
    ...
    static async getSubscriptionsDueForRenewal(): Promise<
        SubscriptionRenewal[]
    > {
        const now = new Date();
        ...
        try {
            ...
            console.error(
                "Error fetching subscriptions due for renewal:",
                error
            );
            throw error;
        }
    ...
    static async createRenewalPaymentOrder(
        subscription: SubscriptionRenewal
    ): Promise<any> {
        try {
            const receipt = `renewal_${
    ...
    static async processSubscriptionRenewal(
        ...
        try {
            ...
            console.log(
                `✅ Renewal processed for subscription ${subscription.subscriptionId}`
            );
        } catch (error) {
            console.error(
                `❌ Failed to process renewal for subscription ${subscription.subscriptionId}:`,
                error
            );
    ...
    static async sendRenewalNotification(
        ...
        try {
            ...
            console.log(
                `📧 Renewal notification sent to ${hotel.admin.email} for hotel ${hotel.name}`
            );
        } catch (error) {
    ...
    static async handleFailedPayments(): Promise<void> {
        try {
            ...
            for (const subscription of failedSubscriptions) {
                ...
                console.log(
                    `⚠️ Subscription ${subscription.id} marked as past_due`
                );
            }
        } catch (error) {
    ...
    static async cancelOverdueSubscriptions(): Promise<void> {
        try {
            ...
            for (const subscription of overdueSubscriptions) {
                ...
                console.log(
                    `🚫 Subscription ${subscription.id} cancelled due to non-payment`
                );
            }
        } catch (error) {
    ...
    static async updateSuccessfulRenewal(
        subscriptionId: string
    ): Promise<void> {
        try {
    ...
    static async runSubscriptionBilling(): Promise<void> {
        ...
        try {
            ...
            console.log(
                "✅ Subscription billing cron job completed successfully"
            );
        } catch (error) {
            console.error("❌ Subscription billing cron job failed:", error);
        }
    }
}
